package com.bucott.store.security.config;

import com.bucott.store.security.filter.JwtAuthenticationFilter;
...
import com.bucott.store.user.service.UserDetailsServiceImpl;
